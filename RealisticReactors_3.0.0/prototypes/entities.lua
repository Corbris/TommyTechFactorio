...
reactor_template = {
	...
	flags = {"placeable-player","player-creation","placeable-off-grid","hidden","not-on-map","not-deconstructable","not-blueprintable","no-copy-paste","not-in-kill-statistics"},
...
reactor_normal.flags = {"placeable-player", "player-creation"}
...
-- show connections but disable buffer
reactor_normal.heat_buffer.specific_heat = "1J"
reactor_normal.heat_buffer.max_transfer = "1W"
reactor_normal.heat_buffer.max_temperature = 1e23
reactor_normal.heat_buffer.min_working_temperature = 1e23
...
reactor_interface = {
	...
	order = "f[nuclear-energy]-a[reactor]",
	flags = {"player-creation","not-rotatable","not-upgradable","not-on-map","no-copy-paste","not-in-kill-statistics"},
...
reactor_eccs = {
	...
	icon_size = reactor_template.icon_size,
	order = "f[nuclear-energy]-a[reactor]",
	flags = {"not-deconstructable","not-blueprintable","not-rotatable","not-upgradable","not-on-map","no-copy-paste","not-in-kill-statistics"},
	resistances = resistances_immune,
	--placeable_by = {item="iron-plate", count = 1},
	max_health = reactor_template.max_health,
...
reactor_power_normal = {
	...
	flags = {"player-creation","not-deconstructable","not-blueprintable","not-upgradable","not-on-map","no-copy-paste","not-in-kill-statistics"},
	order = "f[nuclear-energy]-a[reactor]",
	max_health = 150,
	resistances = resistances_immune,
	collision_mask = {"ghost-layer"},
...
reactor_ruin = {
	...
	max_health = 1000,
	order = "f[nuclear-energy]-a[reactor]",
	flags = {"player-creation","not-deconstructable","not-blueprintable","not-repairable","no-copy-paste","not-in-kill-statistics"},
	--resistances=resistances_immune,
...
cooling_tower = {
	...
	icon_size = 32,
	flags = {"placeable-player", "placeable-player", "player-creation", "hide-alt-info"},
...
cooling_tower_smoke = {
	...
	icon_size = 32,
	order = "f[nuclear-energy]-a[reactor]",
	flags = {"not-blueprintable", "not-deconstructable","not-upgradable","not-on-map","placeable-off-grid","hide-alt-info","no-copy-paste","not-in-kill-statistics"},
